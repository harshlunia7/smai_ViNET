...
echo "Starting Training for AVAD with noise bilinear";
python train.py \
...
--batch_size 2 \
--experiment_name AViNet_bilinear_noise_AVAD_earlystopping;

echo "Starting Training for AVAD with noise concat";
python train.py \
--data_directory /ssd_scratch/cvit/rafaelgetto/ \
--dataset AVAD \
--split 1 \
...
--use_transformer True \
--batch_size 2 \
--experiment_name AViNet_concat_noise_AVAD_earlystopping;
